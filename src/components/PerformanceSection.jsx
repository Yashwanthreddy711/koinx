...
function PerformanceSection() {
  return (
    <div className="p-2 mt-5 bg-white rounded-lg lg:p-6 h-max">
      <div>
        ...
        <div className="py-4 mt-2">
          <div className="flex justify-between ">
            ...
            <div className="w-[500px] h-2 mx-4">
              <div className="h-full bg-gradient-to-r from-red-500 via-orange-500 to-green-500 rounded-2xl mt-7"></div>
              <div className="relative mt-4 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <svg
                  viewBox="0 0 100 100"
                  className="w-2 text-black fill-current lg:w-3 ml-7"
                >
        ...
        <div className="mt-4">
          ...
          <div className="mb-8 lg:flex">
            <div className="mt-3 lg:w-1/2 lg:mr-10 ">
