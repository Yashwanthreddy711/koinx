...
function About() {
  return (
    <div className="p-2 my-5 bg-white rounded-lg h-max lg:p-6">
      <div>
          ...
          <div className="lg:flex border-b-2 border-[#C9CFDD]/40 pb-4">
            <div className="mt-4">
              <div className="lg:w-[400px] h-[151px] bg-gradient-to-br from-[#79F1A4] to-[#0E5CAD] rounded-lg flex">
                <div className="p-3">
                  <img
                    className="object-cover object-right w-32 h-32 rounded-xl"
                ...
                <div className="flex flex-col items-center justify-center p-4 mr-10">
                  <div className="text-xl text-white ">
                    Calculate your Profits
                  </div>
                  <div className="flex items-center px-3 py-2 mt-3 bg-white rounded-lg">
                    Check Now
