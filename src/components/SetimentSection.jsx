...
function SentimentSection() {
  return (
    <div className="p-3 my-5 bg-white rounded-lg h-max lg:p-6">
      <div>
            ...
            <div className="flex p-4">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                ...
                <div className="relative">
                  <div className="absolute p-4 -ml-8 transform -translate-y-1/2 bg-white rounded-full cursor-pointer top-1/2 left-full">
        ...
        <div className="mb-6">
          ...
          <div className="flex mt-2">
            ...
            <div className="px-2 mt-2 lg:px-10">
              <div className="flex items-center p-2">
                <div className="text-[#7C7E8C] text-[15px] mr-9">Buy</div>
                <div className="w-20 h-2 md:w-96">
